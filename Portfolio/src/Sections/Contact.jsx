...
function Contact() {
    ...
    return (
        <div id="connect" className="bg-faf2 font-adlam">
            <div className=" p-10">
                                ...
                                <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a href="https://x.com/adilns786">
                                        ...
                                        >
                                            <path
                                                fill="#007bff"
                                                d="M23.643 4.937c-.835.37-1.732.62-2.675.733a4.656 4.656 0 0 0 2.045-2.57c-.885.523-1.86.894-2.9 1.094a4.605 4.605 0 0 0-7.863 4.197A13.088 13.088 0 0 1 1.671 3.149a4.605 4.605 0 0 0 1.427 6.14c-.747-.023-1.448-.229-2.062-.57v.057a4.606 4.606 0 0 0 3.697 4.513 4.56 4.56 0 0 1-2.05.078 4.607 4.607 0 0 0 4.298 3.2A9.217 9.217 0 0 1 0 19.54 13.007 13.007 0 0 0 7.036 21c8.455 0 13.075-7.008 13.075-13.075 0-.198-.004-.395-.013-.59A9.354 9.354 0 0 0 24 4.557a9.252 9.252 0 0 1-2.657.728 4.604 4.604 0 0 0 2.003-2.548 9.198 9.198 0 0 1-2.976 1.137 4.585 4.585 0 0 0-7.84 3.687c0 .358.04.71.118 1.048A13.028 13.028 0 0 1 1.644 3.203a4.585 4.585 0 0 0 1.419 6.107 4.563 4.563 0 0 1-2.075-.574v.059a4.584 4.584 0 0 0 3.675 4.493 4.573 4.573 0 0 1-2.066.078 4.585 4.585 0 0 0 4.278 3.18 9.194 9.194 0 0 1-5.696 1.964A9.285 9.285 0 0 1 0 18.544 13.014 13.014 0 0 0 7.036 21c8.448 0 13.068-7.005 13.068-13.068 0-.198-.004-.394-.013-.59a9.274 9.274 0 0 0 2.552-2.403z"
                                            />
                                        </svg>
